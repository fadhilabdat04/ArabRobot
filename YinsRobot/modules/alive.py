...
yinzver = "2.0.22"
PHOTO = https://telegra.ph//file/8e4d2922fa48aff2be56d.jpg""

@register(pattern=("/alive"))
async def awake(event):
  TEXT = f"**Hi [{event.sender.first_name}](tg://user?id={event.sender.id}), I'm Yins Robot.** \n\n"
  TEXT += "✨ **I'm Working Properly** \n\n"
  TEXT += f"✨ **Oᴡɴᴇʀ : [DhilSiArab](https://t.me/Arabnihnge)** \n\n"
  ...
  BUTTON = [[Button.url("Help", "https://t.me/Cehasiarab?start=help"), Button.url("Support", "https://t.me/+t5dVb7kwNDhkZGI1")]]
